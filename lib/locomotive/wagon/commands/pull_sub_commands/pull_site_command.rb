module Locomotive::Wagon
  ...
  class PullSiteCommand < PullBaseCommand
    ...
    def _pull
      attributes = current_site.attributes.slice('name', 'strict_slug_enabled', 'locales', 'domains', 'timezone', 'seo_title', 'meta_keywords', 'meta_description', 'picture_thumbnail_url', 'metafields', 'metafields_schema', 'metafields_ui', 'robots_txt')
